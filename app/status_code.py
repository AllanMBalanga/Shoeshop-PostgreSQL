...
#check if service type is repair
def validate_type_of_service(service_type, models_ServiceCreate_type):
    if service_type != models_ServiceCreate_type:
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
            detail="Service type not sale"
        )
